...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://hl7chile.cl/fhir/ig/clips/0.2.0/DiagnosticReport-DiagnosticReportLab-CL-Ejemplo.html");
  else if (id == "DiagnosticReportAlergia-CL-Ejemplo")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clips/0.2.0/DiagnosticReport-DiagnosticReportAlergia-CL-Ejemplo.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \0.2.0\crdiagnosticreport.asp) .
</body>
</html>
