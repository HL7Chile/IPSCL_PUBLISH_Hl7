...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://hl7chile.cl/fhir/ig/clips/0.2.0/PractitionerRole-RolProfesionalMedInternaCLEjemplo.html");
  else if (id == "RolProfesionalCLEjemplo")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clips/0.2.0/PractitionerRole-RolProfesionalCLEjemplo.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \0.2.0\crpractitionerrole.asp) .
</body>
</html>
