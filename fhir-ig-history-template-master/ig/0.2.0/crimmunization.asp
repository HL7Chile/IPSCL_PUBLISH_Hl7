...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://hl7chile.cl/fhir/ig/clips/0.2.0/Immunization-Inmunizacion-CL-Ejemplo.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \0.2.0\crimmunization.asp) .
</body>
</html>
